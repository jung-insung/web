...
public class DispatcherServlet extends HttpServlet {
  ...
  protected void service(HttpServletRequest request,
    ...
    switch (uri) {
      ...
      case "/mvc/article/updateArticleForm" -> articleController.updateArticleForm(request, response);
      case "/mvc/article/deleteArticle" -> articleController.deleteArticle(request, response);
      case "/mvc/article/deleteArticleForm" -> articleController.deleteArticleForm(request, response);
